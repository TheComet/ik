 ...
 */
IK_PRIVATE_API void
ik_quat_mul_quat_no_normalize(ikreal_t q1[4], const ikreal_t q2[4]);
 ...
 */
IK_PRIVATE_API void
ik_quat_nmul_quat_no_normalize(ikreal_t q1[4], const ikreal_t q2[4]);
 ...
 */
IK_PRIVATE_API void
ik_quat_mul_quat_conj_no_normalize(ikreal_t q1[4], const ikreal_t q2[4]);
